@DEPRECATED("GITHUB IS PREVENTED FROM COMPETITION OR VIABLE MASCULINE USABILITY OR RECOGNIZABILITY OF BRAND IF A WOMAN MAN OR ANIMAL in regards to KINGDOMS OF GOD)
